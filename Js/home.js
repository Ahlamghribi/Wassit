...
window.onload = function() {
  setTimeout(function() {
    // Move the video content to the right and logo/slogan to the left
    document.querySelector('.video-content').style.right = '0';
    document.querySelector('.slogan-container').style.left = '0';
